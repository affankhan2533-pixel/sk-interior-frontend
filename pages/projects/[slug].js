      ...
      <main className="overflow-x-hidden">
        ...
        >
          <div className="container-wide">
            ...
            {/* Metadata Bar */}
            <div
              className={`grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 pb-12 border-t border-white/10 text-[13px] transition-all duration-1000 delay-300 ${
                heroReady ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
              }`}
            >
              <div>
        ...
        {/* ═══════════════════════════════════════════════════════════════════
            SECTION 4 — NEXT PROJECT INTERACTIVE PREVIEW
            ═══════════════════════════════════════════════════════════════════ */}
        {nextProject && (
          <section className="section-padding" style={{ background: 'var(--color-surface)' }}>
            <div className="container-wide">
              <SectionReveal>
                <div className="p-8 sm:p-12 rounded-2xl bg-white/40 border border-black/10 shadow-luxe flex flex-col md:flex-row items-center justify-between gap-8 group">
                  <div className="space-y-3">
                    ...
                    <Link href={`/projects/${nextProject.slug || nextProject._id}`}>
                      <h3
                    ...
                    {(nextProject.category || nextProject.location) && (
                      <p className="text-xs text-[#151515]/50 uppercase tracking-wider font-light" style={{ fontFamily: 'var(--font-body)' }}>
                        {[nextProject.category, nextProject.location].filter(Boolean).join(' · ')}
                      </p>
                    )}
                  </div>
